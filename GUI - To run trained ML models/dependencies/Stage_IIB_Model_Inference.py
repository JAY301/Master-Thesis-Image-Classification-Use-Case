...
load_model=os.path.join(loaded_model_path,'dependencies\ML_model_for_stage_2_images_with_additional_classes.pth')

csv_file_name="dependencies/Classified_Images_stage_IIB.csv"
...
classes = ['Other', 'back ear tearing', 'exposed elastic', 'front ear tearing', 'hook creep', 'hook missing', 'tape tearing']
