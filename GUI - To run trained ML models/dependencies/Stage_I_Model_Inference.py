...
When pointed into the image folder, this script will
1. create a folder ..test/test/
2. put all pictures there
3. take a pretrained model
4. classify and output a CSV
5. put the each picture into a folder of class type

This script classifies a set of given images into five classes
such as, 
	1. Product Defect
	2. Lot Code
	3. Package
...
load_model=os.path.join(loaded_model_path,'dependencies\ML_model_for_stage_1_images.pth')

csv_file_name="dependencies/Classified_Images_stage_I.csv"
